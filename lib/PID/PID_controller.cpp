...
float ReceiveThrottleInput(){
    ...
    int MatchingThrottleInput = ESC_PWM;
...
void control_throttle(){
    ...
    // MotorInput1 = (InputThrottle - ReceiveRollInput() - ReceivePitchInput() - ReceiveYawInput()); 
    // MotorInput2 = (InputThrottle - ReceiveRollInput() + ReceivePitchInput() + ReceiveYawInput());
    // MotorInput3 = (InputThrottle + ReceiveRollInput() + ReceivePitchInput() - ReceiveYawInput());
    // MotorInput4 = (InputThrottle + ReceiveRollInput() - ReceivePitchInput() + ReceiveYawInput());
