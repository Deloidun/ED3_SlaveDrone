...
void BMP280_Calibration(){
    for (int BaroRateCalibrationNumber = 0; BaroRateCalibrationNumber < 2000; BaroRateCalibrationNumber ++){
        float AltitudeBarometer = bmp.readAltitude(1013.25);
...
// float Altitude, AltitudeBarometer = 0, AltitudeBarometerStartUp = 0;
// float LoopTimer;
// float Temperature, Pressure;
...
// void BMP280_Calibration(){
//     for (int BaroRateCalibrationNumber = 0; BaroRateCalibrationNumber < 2000; BaroRateCalibrationNumber ++){
//         AltitudeBarometer = bmp.readAltitude(1013.25);
//         AltitudeBarometerStartUp += AltitudeBarometer;  
//     } AltitudeBarometerStartUp /= 2000; //meter
// }
...
//     Pressure = bmp.readPressure();
//     Kalman_2D();
//     // Serial.println (String(LoopTimer/1000) + "      Altitude >> " + String(Altitude) + " cm");
//     // LoopTimer = micros();
// }
